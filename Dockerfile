...
# Borrowed from https://github.com/meanbee/docker-bastion
# Who borrowed from https://github.com/atomney/bastion
MAINTAINER Ryan VanMiddlesworth <ryan@fountstudio.com>

# Install required packages
RUN apk add --no-cache openssh bash wget curl vim shadow postgresql-client mysql-client screen tmux bind-tools
